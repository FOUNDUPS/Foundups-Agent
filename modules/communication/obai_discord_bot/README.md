...
- No channel allow-list filtering (responds in any channel it can see)
...
**Guild**: FOUNDUPS (`412646632992014336`)
**Bot Application**: OBAI (`1127122752776699915`)
**Status**: Authorized and in server
...
|------------|--------|---------|
| View Channels | ✅ | See public channels |
| Send Messages | ✅ | Post in channels |
| Send Messages in Threads | ✅ | Post in threads |
| Create Public Threads | ✅ | Future thread creation |
| Embed Links | ✅ | Structured embeds |
| Attach Files | ✅ | Screenshots, diagrams |
| Read Message History | ✅ | Context for responses |
| Add Reactions | ✅ | Acknowledgment signals |
| Use External Emojis | ✅ | Visual indicators |
| Use Slash Commands | ✅ | Future slash support |
| Administrator | ❌ | Never |
| Manage Channels/Roles/Server | ❌ | Never |
| Kick/Ban | ❌ | Never |
| Manage Messages | ❌ | Never |
...
4. **Test DM**: DM the bot directly → should NOT reply (guild-only)
...
| `Target guild not found` | Bot not invited to guild | Re-invite with correct permissions |
| Bot online but no reply | MESSAGE_CONTENT intent disabled | Enable in Developer Portal |
| Bot replies everywhere | No channel filter in Phase 1 | Expected behavior — Phase 2 adds filtering |
