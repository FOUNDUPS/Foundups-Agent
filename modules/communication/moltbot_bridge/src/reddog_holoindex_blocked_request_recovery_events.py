...
def build_stage_payload(
    *, schema_version: str, recovery_id: str, request_digest: str,
    ...
    incident_kind: str, task_id: str, request_event_id: str,
    target_repo_head_sha: str, workspace_repo_head_sha: str,
    observed_authority_head_sha: str, authority_root_digest: str,
    ...
    payload = {
        ...
        "incident_kind": incident_kind, "task_id": task_id,
        "request_event_id": request_event_id,
        "target_repo_head_sha": target_repo_head_sha,
        "workspace_repo_head_sha": workspace_repo_head_sha,
        "observed_authority_head_sha": observed_authority_head_sha,
    ...
    *, stage_payload: Mapping[str, Any], generation_id: str,
    ...
    payload = {
        **{key: stage_payload[key] for key in (
            ...
            "incident_kind", "request_event_id", "target_repo_head_sha",
