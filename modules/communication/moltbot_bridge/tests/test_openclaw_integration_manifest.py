...
EXPECTED_UPSTREAM = {
    "openclaw_gateway_artifact_provider": {
        ...
        "origin": "UPSTREAM_CLI",
        "provider_runtime": RUNTIME_MODE_OPENCLAW_GATEWAY, "capability_boundary": "text_artifact_only_no_tools",
        "implementation_paths": [
    ...
    "hermes_api_artifact_provider": {
        ...
        "owner_module": "modules/communication/moltbot_bridge",
        "origin": "UPSTREAM_API",
        "provider_runtime": RUNTIME_MODE_HERMES_API, "capability_boundary": "native_single_leaf_delegate_no_child_tools",
        "implementation_paths": [
            "modules/communication/moltbot_bridge/src/reddog_artifact_generation_provider_bootstrap.py",
        ...
        "invocation_surface": "authenticated loopback POST /v1/runs with delegate_task event proof",
...
def _upstream_semantic_errors(entry, expected):
    exact = {
        ...
        "capability_boundary": expected["capability_boundary"],
