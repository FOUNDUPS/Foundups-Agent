...
- Added a composed socket-v2 -> durable E0 grant -> resolve-per-sign Ed25519 signer -> external issuer -> real WRE effect regression, plus local-key, split-root, generation-overrun, and rollback attacks.
