...
Evidence: `O:/Foundups-Agent-audits/20260923-rsi-persistence-orm/{baseline,candidate,independent}/receipt.json`; exact128 IDs frozen before extraction. Python audit hooks constrain these known fixtures, not hostile native code or an OS sandbox.
