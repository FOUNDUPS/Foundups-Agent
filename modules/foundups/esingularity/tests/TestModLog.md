...
- Fresh local evidence: 18 configuration checks passed using Node v22.16.0 with `--experimental-strip-types`, against the patch based on `3b74a04205b05fc0d84172d52b8862ff608b1d6e`.
