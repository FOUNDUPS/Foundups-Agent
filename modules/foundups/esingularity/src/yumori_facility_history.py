...
This module keeps City-published operating history, City fiscal burden, and
closed-building carrying-cost evidence separate from YUMORI project economics.
It contains no project forecast equations.
