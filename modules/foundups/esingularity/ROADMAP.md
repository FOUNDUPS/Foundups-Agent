...
- [x] Centralize approved YUMORI.me identity, JOIN, and JHR branding in the shared website skill, with eSingularity and YUMORI.me entrypoints plus ticker/report cross-references. `guardian` may explain 湯守 in English but is not a second brand or identity lockup. This records the language contract; it does not publish or certify live compliance.
