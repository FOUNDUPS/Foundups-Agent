...
- [x] Add the repository-owned [YUMORI Economic Model](docs/YUMORI_ECONOMIC_MODEL.md) as the project-finance calculation authority, with FIN.YUMORI parity, demand-capped heat recovery, and a sourced JHR Japan infrastructure-flow ledger; keep it separate from FoundUps ROC/token economics.
