...
const source: VisionSource[] = [
  {
    id: 'vision', image: '/campaign-phase-1.jpg',
    alt: {
  ...
  },
  {
    ...
    summary: { ja: '解体費という不可逆な支出の前に、再利用を検証する選択肢を比較します。', en: 'Compare the option to test reuse before making an irreversible demolition expenditure.', pt: 'Compare a opção de testar o reuso antes de realizar uma despesa irreversível de demolição.' },
    action: { ja: '解体が決まる前に、福井市と市議会へ声を', en: 'Speak to Fukui City and Council before demolition is decided', pt: 'Fale com a cidade e o conselho antes da decisão de demolir' },
    evidence: {
      ja: ['報告資料：将来の解体見込み 約15.8億円。確定契約額ではありません。', '公表資料：2018年度利用者 129,649人。', '再利用の事業性、資金調達、工事費は検証中です。'],
      en: ['Reported: future demolition estimate about ¥1.58B; this is not a final contract price.', 'Verified public record: FY2018 users 129,649.', 'Reuse economics, financing and construction costs remain under validation.'],
      pt: ['Reportado: estimativa futura de demolição de cerca de ¥1,58 bi; não é preço contratual final.', 'Registro público verificado: 129.649 usuários no FY2018.', 'A viabilidade econômica do reuso, o financiamento e os custos de construção seguem em validação.'],
    },
    link: { label: { ja: '公表根拠を見る', en: 'See the published evidence', pt: 'Ver as evidências publicadas' }, href: '#evidence' },
  },
  {
    id: 'culture-after-dark', image: '/campaign-phase-2.jpg',
    ...
    action: { ja: 'この建物を、夜の文化拠点へ。YUMORIに参加', en: 'Help make this a cultural destination after dark', pt: 'Ajude a transformar este lugar em destino cultural noturno' },
    evidence: {
  ...
  {
    id: 'onsen-destination', image: '/concept-onsen.jpg',
    ...
    action: { ja: '温泉を残す準備委員会に参加', en: 'Join the committee working to preserve the onsen', pt: 'Participe do comitê para preservar o onsen' },
    evidence: {
  ...
  {
    id: 'compute-rice-field', image: '/yumori-compute-field.webp',
    ...
    action: { ja: '地域のコンピュートを、地域の手に。YUMORIに参加', en: 'Keep regional compute in regional hands. Join YUMORI', pt: 'Mantenha a computação regional em mãos locais. Participe' },
    evidence: {
  ...
  {
    id: 'cogdc', image: '/yumori-compute-field.webp',
    ...
    action: { ja: '回収熱を温泉へ。技術検証を支える', en: 'Help test whether recovered heat can serve the onsen', pt: 'Ajude a testar se o calor recuperado pode servir ao onsen' },
    evidence: {
  ...
  {
    id: 'esingularity-lab', image: '/satellite-view.jpeg',
    ...
    action: { ja: '60のFoundUpプロジェクトを福井へ。仲間になる', en: 'Help bring 60 FoundUp projects to Fukui', pt: 'Ajude a trazer 60 projetos FoundUp para Fukui' },
    evidence: {
    ...
    link: { label: { ja: 'イノベーション・スペース構想を見る', en: 'See the Innovation Space concept', pt: 'Ver o conceito do Espaço de Inovação' }, href: '#innovation-space' },
  },
  {
    id: 'local-problem', image: '/yumori-autonomous-agriculture.png',
    ...
    action: { ja: '福井の課題を、福井で解く。YUMORIに参加', en: 'Help solve Fukui’s problems in Fukui', pt: 'Ajude a resolver os problemas de Fukui em Fukui' },
    evidence: {
    ...
    link: { label: { ja: '地域活用を見る', en: 'See local applications', pt: 'Ver aplicações locais' }, href: '#innovation-space' },
  },
  {
    id: 'fukui-prototype', image: '/yumori-inzai-fukui-comparison.webp',
  ...
  {
    id: 'choice', image: '/satellite-view.jpeg',
    ...
    action: { ja: 'なくなる前に、声を。YUMORIに参加', en: 'Use your voice before the choice disappears', pt: 'Use sua voz antes que a escolha desapareça' },
    evidence: {
...
export const visionUi: Record<YumoriLocale, { label: string; title: string; previous: string; next: string; pause: string; play: string; details: string; fullscreen: string; exit: string; join: string; navigation: string }> = {
  ja: { label: 'プロジェクト eSingularity · 10枚の構想', title: '壊す前に、未来を比べる。', previous: '前へ', next: '次へ', pause: '自動再生を止める', play: '自動再生', details: '根拠と注記', fullscreen: '全画面で見る', exit: '全画面を閉じる', join: '参加・行動はYUMORI.me', navigation: 'スライドを選ぶ' },
  en: { label: 'PROJECT ESINGULARITY — 10-SLIDE VISION', title: 'Before Demolition, Compare the Future.', previous: 'Previous', next: 'Next', pause: 'Pause autoplay', play: 'Autoplay', details: 'Evidence & notes', fullscreen: 'View full screen', exit: 'Exit full screen', join: 'Participation & action: YUMORI.me', navigation: 'Choose a slide' },
  pt: { label: 'PROJETO ESINGULARITY — VISÃO EM 10 SLIDES', title: 'Antes de demolir, compare o futuro.', previous: 'Anterior', next: 'Próximo', pause: 'Pausar reprodução', play: 'Reprodução automática', details: 'Evidências e notas', fullscreen: 'Ver em tela cheia', exit: 'Sair da tela cheia', join: 'Participação e ação: YUMORI.me', navigation: 'Escolher um slide' },
};
