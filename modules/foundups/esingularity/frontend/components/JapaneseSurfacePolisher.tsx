...
const triples: CopyTriple[] = [
  ...
  // 2026-09-14 cross-route surface audit: source is Japanese-first; these preserve complete alternate-language rendering.
  { ja: '01 / なぜ — 何が来るのかを知る', en: '01 / WHY — KNOW WHAT IS COMING', pt: '01 / POR QUÊ — SAIBA O QUE ESTÁ CHEGANDO' },
  { ja: '02 / 何をする — 解体前に再利用を', en: '02 / WHAT — REUSE BEFORE DEMOLITION', pt: '02 / O QUÊ — REUTILIZAR ANTES DA DEMOLIÇÃO' },
  { ja: '03 / どう進める — コンピュートを地域再生へ', en: '03 / HOW — TURN COMPUTE INTO REVITALIZATION', pt: '03 / COMO — TRANSFORMAR COMPUTAÇÃO EM REVITALIZAÇÃO' },
  { ja: '行動 / 1,000 YUMORI.me', en: 'ACT / 1,000 YUMORI.me', pt: 'AÇÃO / 1.000 YUMORI.me' },
  { ja: 'ジャパン・ハイパースケーラー・レポート（JHR）を読む →', en: 'Read the Japan Hyperscaler Report (JHR) →', pt: 'Leia o Japan Hyperscaler Report (JHR) →' },
  { ja: '福井の経済的な未来', en: 'FUKUI ECONOMIC FUTURE', pt: 'FUTURO ECONÔMICO DE FUKUI' },
  { ja: '福井に残す価値', en: 'WHAT FUKUI RETAINS', pt: 'O QUE FICA EM FUKUI' },
  { ja: '価値を福井に残す', en: 'KEEP VALUE IN FUKUI', pt: 'MANTER O VALOR EM FUKUI' },
  { ja: '小さく始める · 需要とともに育てる', en: 'START SMALL · GROW WITH DEMAND', pt: 'COMECE PEQUENO · CRESÇA COM A DEMANDA' },
  { ja: '温泉 × 学び × COG DC × 地域', en: 'ONSEN × LEARNING × COG DC × COMMUNITY', pt: 'ONSEN × APRENDIZAGEM × COG DC × COMUNIDADE' },
  { ja: '組織より、まず人から', en: 'PEOPLE BEFORE ORGANIZATION', pt: 'PESSOAS ANTES DA ORGANIZAÇÃO' },
  { ja: '立ち上げチーム', en: 'LAUNCH TEAM', pt: 'EQUIPE INICIAL' },
  { ja: '創設ペア', en: 'FOUNDING PAIR', pt: 'DUPLA FUNDADORA' },
  { ja: 'プロフィール ↗', en: 'PROFILE ↗', pt: 'PERFIL ↗' },
  { ja: '掲載は本人の同意を得てから', en: 'THE DIRECTORY GROWS WITH PERMISSION', pt: 'O DIRETÓRIO CRESCE COM PERMISSÃO' },
  { ja: '人 × 場所 × コンピュート × 地域', en: 'PEOPLE × PLACE × COMPUTE × COMMUNITY', pt: 'PESSOAS × LUGAR × COMPUTAÇÃO × COMUNIDADE' },
  { ja: '← チーム一覧', en: '← TEAM DIRECTORY', pt: '← DIRETÓRIO DA EQUIPE' },
  { ja: 'この人がここにいる理由', en: 'WHY THIS PERSON IS HERE', pt: 'POR QUE ESTA PESSOA ESTÁ AQUI' },
  { ja: '透明性', en: 'TRANSPARENCY', pt: 'TRANSPARÊNCIA' },
  { ja: '温泉の思い出', en: 'A MEMORY FROM THE ONSEN', pt: 'UMA MEMÓRIA DO ONSEN' },
  { ja: '人間の権限 · AIの能力', en: 'HUMAN AUTHORITY · AI CAPABILITY', pt: 'AUTORIDADE HUMANA · CAPACIDADE DA IA' },
  { ja: '01 · プレイリスト', en: '01 · PLAYLIST', pt: '01 · PLAYLIST' },
  { ja: '九頭竜を聴く', en: 'LISTEN TO KUZURYU', pt: 'OUÇA KUZURYU' },
  { ja: '活動記録', en: 'FIELD NOTES', pt: 'NOTAS DE CAMPO' },
  { ja: '確認済みの公開リンク', en: 'VERIFIED PUBLIC LINKS', pt: 'LINKS PÚBLICOS VERIFICADOS' },
  { ja: 'チームへ戻る', en: 'BACK TO THE PEOPLE', pt: 'VOLTAR À EQUIPE' },
  { ja: 'チーム一覧', en: 'TEAM DIRECTORY', pt: 'DIRETÓRIO DA EQUIPE' },
];
