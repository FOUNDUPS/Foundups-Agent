...
const copy: Record<string, [string, string]> = {
  ...
  '福井の次の30年を動かす計算力を、': ['It is about who owns the compute ', 'É sobre quem controla a computação '],
  '誰が持つかという話です。': ['that will power Fukui’s next 30 years.', 'que impulsionará os próximos 30 anos de Fukui.'],
  ...
  '約1.3億〜5.1億円 / 年': ['About ¥130M–¥510M / year', 'Cerca de ¥130–510 milhões / ano'],
  ...
  '2018年度の利用実績に、1人あたり1,000円の追加消費仮定から、福井県の2024年日帰り観光消費単価3,972円までを掛けた単純な試算です。建設、運営、コンピュート収入、雇用、経済波及効果は含みません。': ['A simple screening calculation applying ¥1,000 in assumed incremental spending through Fukui Prefecture’s 2024 average day-trip spending of ¥3,972 to fiscal-2018 attendance. It excludes construction, operations, compute revenue, jobs, and multiplier effects.', 'Um cálculo preliminar simples que aplica desde ¥1.000 em gasto adicional presumido até a média de ¥3.972 por viagem de um dia em Fukui em 2024 ao público do ano fiscal de 2018. Não inclui construção, operação, receita de computação, empregos nem efeitos multiplicadores.'],
  '福井県観光客入込数（推計）2024年': ['Fukui Prefecture Tourism Statistics 2024', 'Estatísticas de Turismo de Fukui 2024'],
