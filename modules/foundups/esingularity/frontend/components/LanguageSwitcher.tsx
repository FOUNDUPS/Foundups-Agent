...
const copy: Record<string, [string, string]> = {
  ...
  '本委員会の現在の要請は、9月25日の採決で「旧すかっとランド九頭竜解体準備事業」を含む予算案について反対票を求めることです。以前の「60日間の延期」「一定期間の保留」は、現在の要請ではありません。': ['The committee’s current request is a NO vote on the budget containing the Former Sukatto Land Kuzuryu Demolition Preparation Project at the September 25 vote. The earlier “60-day delay” and “fixed-period hold” are no longer the committee’s request.', 'O pedido atual do comitê é um voto NÃO ao orçamento que inclui o Projeto de Preparação para a Demolição do antigo Sukatto Land Kuzuryu na votação de 25 de setembro. O pedido anterior de “adiamento de 60 dias” e de “suspensão por prazo determinado” não é mais o pedido atual do comitê.'],
  '予算判断と、YUMORI案の採否は別の判断です。': ['The budget vote and adoption of the YUMORI proposal are separate decisions.', 'A votação do orçamento e a adoção da proposta YUMORI são decisões separadas.'],
  '反対票は、YUMORI案の採用、データセンター建設、市による出資・債務保証、補助金交付、随意契約を承認するものではありません。再利用案の採否は、別途の正式手続、技術・財務検証、地権者・地域との協議、公平な審査を経て判断されるべきだと、本委員会は考えています。': ['A NO vote would not approve the YUMORI proposal, construction of a data center, city investment or debt guarantees, grant funding, or a non-competitive contract. The committee’s position is that any reuse proposal should be decided separately through formal procedures, technical and financial validation, consultation with landowners and the community, and a fair review.', 'Um voto NÃO não aprovaria a proposta YUMORI, a construção de um data center, investimento ou garantias de dívida pela cidade, concessão de subsídios ou contratação sem concorrência. A posição do comitê é que qualquer proposta de reutilização seja decidida separadamente, por procedimentos formais, validação técnica e financeira, diálogo com proprietários e comunidade e análise justa.'],
  '公開記録': ['Public record', 'Registro público'],
  'プロジェクト概要': ['Project overview', 'Visão geral do projeto'],
  '政策・経済・再利用エビデンス（03）': ['Policy, economics & reuse evidence (03)', 'Evidências de política, economia e reutilização (03)'],
  'PPP/PFI提案資料（05）': ['PPP/PFI proposal materials (05)', 'Materiais da proposta PPP/PFI (05)'],
  '財務モデル': ['Financial model', 'Modelo financeiro'],
  'この記載は設立準備委員会の見解であり、福井市の公式見解ではありません。': ['This statement reflects the Preparatory Committee’s position and is not an official position of Fukui City.', 'Esta declaração reflete a posição do Comitê Preparatório e não é uma posição oficial da cidade de Fukui.'],
  '設立準備委員会の現在の要請と根拠を見る': ['See the Preparatory Committee’s current request and evidence', 'Ver o pedido atual e as evidências do Comitê Preparatório'],
