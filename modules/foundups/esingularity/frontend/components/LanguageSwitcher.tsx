...
const copy: Record<string, [string, string]> = {
  ...
  'yumori.infoを共有する': ['Share yumori.info', 'Compartilhar yumori.info'],
  'YUMORI市民宣言に参加する': ['Join the YUMORI citizens’ declaration', 'Participar da declaração cidadã YUMORI'],
  ...
  'COGDC、温泉、教育、食、文化をつなぐ計画を読む。': ['Read how the plan connects COGDC, the onsen, education, food, and culture.', 'Leia como o plano conecta COGDC, onsen, educação, gastronomia e cultura.'],
  ...
  '約1.3億〜7.2億円 / 年': ['¥129.6M–¥719.0M / year', '¥129,6–719,0 milhões / ano'],
  ...
  '約38.9億〜215.7億円 / 30年': ['¥3.89B–¥21.57B / 30 years', '¥3,89–21,57 bilhões / 30 anos'],
  ...
  '来場者数、再来訪、宿泊、食・買い物・交通の消費を追跡します。現在数字で示しているのは、この層だけです。': ['Track attendance, repeat visits, overnight stays, and spending on food, shopping, and transport. This is the only layer currently quantified.', 'Acompanhar público, visitas repetidas, pernoites e gastos com alimentação, compras e transporte. Esta é a única camada atualmente quantificada.'],
  '県内取引と所得への波及': ['Local supplier and income effects', 'Efeitos sobre fornecedores e renda locais'],
  '県内調達、横丁の売上、新規事業、給与、県内に残る消費を確認し、福井県産業連関表で分析します。': ['Measure local procurement, yokocho sales, business starts, payroll, and locally retained spending before applying Fukui’s input-output table.', 'Medir compras locais, vendas do yokocho, novos negócios, folha de pagamento e gastos retidos na região antes de aplicar a matriz insumo-produto de Fukui.'],
  '雇用・税収・地域への還元': ['Jobs, tax revenue, and community returns', 'Empregos, receita tributária e retorno à comunidade'],
  '建設雇用と常用雇用を分け、税収、学生・大学のプロジェクト、連携機関、地域への還元を検証します。分析完了まで数字は掲載しません。': ['Separate construction from permanent jobs, then verify tax revenue, student and university projects, partnerships, and community returns. No figures will be published until the analysis is complete.', 'Separar empregos de construção dos permanentes e verificar receita tributária, projetos de estudantes e universidades, parcerias e retorno à comunidade. Nenhum valor será publicado até a conclusão da análise.'],
  ...
  '地域キャンペーンは何を測っているか': ['What successful community campaigns measure', 'O que campanhas comunitárias bem-sucedidas medem'],
