      ...
      <main id="top">
        ...
        <section className="story section" id="story" aria-labelledby="story-title">
          ...
          <div className="visitor-impact" aria-labelledby="visitor-impact-title">
            ...
            <div className="impact-layers" role="list" aria-label="経済効果を検証する三つの段階"><article className="measured" role="listitem"><span>NOW · CALCULATED</span><strong>来場者の直接消費</strong><p>来場者数、再来訪、宿泊、食・買い物・交通の消費を追跡します。現在数字で示しているのは、この層だけです。</p></article><article role="listitem"><span>NEXT · INPUT-OUTPUT</span><strong>県内取引と所得への波及</strong><p>県内調達、横丁の売上、新規事業、給与、県内に残る消費を確認し、福井県産業連関表で分析します。</p></article><article role="listitem"><span>AFTER VALIDATION</span><strong>雇用・税収・地域への還元</strong><p>建設雇用と常用雇用を分け、税収、学生・大学のプロジェクト、連携機関、地域への還元を検証します。分析完了まで数字は掲載しません。</p></article></div>
