...
description: Ground YUMORI correspondence in live Gmail/CRM state, preserve routing consent, write in the canonical 0102 proxy voice, reconcile receipts, and promote repeated operator failures into reusable rules.
version: 0.6.0
author: 0102
...
# YUMORI correspondence / contact ledger
...
For every substantive YUMORI correspondence task:
...
- `YUMORI`: clear stakeholder/project correspondence.
