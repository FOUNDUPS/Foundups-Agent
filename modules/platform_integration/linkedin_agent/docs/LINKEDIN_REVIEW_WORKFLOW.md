...
Contract updated 2026-09-15. This compact index connects the existing LinkedIn skills; it is not a new orchestrator, background service or claim of live executor compliance.
...
1. Existing `linkedin_engagement` entrypoint routes the review.
