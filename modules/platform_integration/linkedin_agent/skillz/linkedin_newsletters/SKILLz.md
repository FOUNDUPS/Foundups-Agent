...
Develop the next issue from current evidence and prior conversations without
...
Track `IDEA -> RESEARCHED -> DRAFTED -> REVIEWED -> APPROVED -> PUBLISHED ->
VERIFIED_LIVE`; track `SCHEDULED_VERIFIED` separately until actually live.
