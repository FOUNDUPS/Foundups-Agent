...
| WSP 22 | ModLog Structure and Versioning Protocol | Active | Canonical ModLog structure, journal format, versioning rules, and anti-bloat guidance. Templates in annexes (per-FoundUp customizable) | WSP 51, WSP 60, WSP 83 | Documentation, progress tracking, versioning |
...
| WSP 60 | Module Memory Architecture | Active | Memory management for autonomous modules | WSP 1, WSP 3 | Memory architecture, persistence |
| WSP 61 | Theoretical Physics Foundation Protocol | Active | Theoretical physics foundations for quantum-cognitive development | WSP 54, WSP 60, WSP 47, WSP 22 | Theoretical foundations, quantum mechanics, historical context |
| WSP 62 | Large File and Refactoring Enforcement Protocol | Active | Differential candidate-debt control with WSP 87 tiered thresholds (800/1000/1500), exact-base attribution, and bounded exemptions | WSP 4, WSP 47, WSP 54, WSP 49 | File size tiers, candidate-debt enforcement, modular architecture |
...
| WSP 80 | Cube-Level DAE Orchestration Protocol | Active | Implements WSP 27's 4-phase DAE architecture through independently scoped, resource-bounded FoundUp cubes | WSP 3, WSP 15, WSP 27, WSP 46, WSP 49, WSP 60, WSP 73, WSP 77, WSP 84, WSP 95, WSP 97, WSP 103, WSP 104 | Code-specific DAE orchestration, cube scope, bounded resources, pattern memory |
...
| WSP 98 | FoundUps Mesh-Native Architecture Protocol | Active target | Defines evidence gates for evolving resident-hub FoundUps toward peer-assisted and federated operation without moving identity or effect authority into clients | WSP 27, WSP 80, WSP 3, WSP 97, WSP 103, WSP 104 | Mesh target, federation, peer assistance, tenant isolation, truth-labelled scale |
