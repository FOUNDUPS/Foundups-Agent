...
Version 0.4.43 is the canonical thin-client release from current `main`. It
...
2. Run `Extensions: Install from VSIX...` and select the generated `reddog-0.4.43.vsix` (or current package version).
