...
includes(extensionSnippet.content, "const EXTENSION_VERSION = '0.4.129'", 'target snippet must include extension.js source');
...
includes(targetSection.text, "const EXTENSION_VERSION = '0.4.129'", 'target recall must include source snippet');
...
includes(boundedContext.text, "const EXTENSION_VERSION = '0.4.129'", 'bounded context must include source snippet');
