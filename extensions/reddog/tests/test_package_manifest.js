...
assert.strictEqual(pkg.version, '0.4.141');
...
assert.strictEqual(surface.EXPECTED_RUNTIME_FILES.length, 64);
assert.strictEqual(surface.EXPECTED_PACKAGE_FILES.length, 68);
const packageReceipt = surface.packageSurfaceReceipt(surface.EXPECTED_PACKAGE_FILES);
assert.strictEqual(packageReceipt.file_count, 68);
...
assert.strictEqual(packageReceipt.text_file_count, 67);
