...
assert.strictEqual(pkg.version, '0.4.61', 'package version must be 0.4.61');
includes(extensionJs, "const EXTENSION_VERSION = '0.4.61'", 'extension build mismatch');
...
includes(readme, 'Version: 0.4.61', 'README version mismatch');
...
assert.strictEqual(spinePreview.governed_work_order_candidate.red_dog_instance_id, 'foundups-agent-0.4.61', 'candidate must bind extension version');
...
includes(extensionSnippet.content, "const EXTENSION_VERSION = '0.4.61'", 'target snippet must include extension.js source');
...
includes(targetSection.text, "const EXTENSION_VERSION = '0.4.61'", 'target recall must include source snippet');
...
includes(boundedContext.text, "const EXTENSION_VERSION = '0.4.61'", 'bounded context must include source snippet');
