...
- **Next gate:** RedDog must produce or receive the signed authority + sovereign selection packet automatically before the runtime wire can create a real WRE worktree without 012 copy/paste.
