...
| Current RSI ticket path | PR1895 comparison qualification is merged and retired with verified PR/main checks. [Invocation-scoped costs](modules/infrastructure/wre_core/ROADMAP.md#invocation-scoped-cost-comparability--2026-09-23) now prevent dependency-only cost acceptance:22focused +136existing cases pass locally/independently. Next14/P1 qualifies remaining ROC assumptions as one profile; complete oracle identity, domain/native admission and retained RSI remain open. |
