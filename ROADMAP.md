...
- LinkedIn wrapper/direct-like PR1867 and session preview PR1868 are merged with verified PR/main checks. [Connection policy qualification](modules/platform_integration/linkedin_agent/docs/LINKEDIN_REVIEW_WORKFLOW.md#rsi-connection-policy-qualification--2026-09-22) now passes ten fixed inert cases locally and independently, exposing preview request-history/pending mutation. Production source unchanged. Re-scoring selects a narrow no-bookkeeping-mutation policy preview12/P2; browser access, live authority and retained RSI remain separate. Exact publication and next-action evidence remain in the canonical backlog.
