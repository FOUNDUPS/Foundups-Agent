...
| Dependency work | Existing gRPC #1365 qualified at 15/P1: one lock record changes to 1.14.4; 298 remain unchanged. Strict isolated install and 13 paired normal cases pass; four baseline crash/assertion failures are preserved and all four patched cases pass. Independent qualification accepted; final four-file review/publication/CI pending. Node 20, real HTTP/2, private server decompression, app and deployment remain unverified. Forge #1374 and both main workflows passed; alerts 45–48 fixed. Next after closure: LinkedIn dry-run qualification at 13/P1, ahead of tied XML/cleanup work by direct relevance to the daily-work effect boundary. |
