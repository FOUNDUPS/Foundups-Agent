...
- LinkedIn instruction owners PR1863/1865 are merged; fresh scoped ownership reconciliation closes the previous hold. Existing fake-only dry-run qualification13/P1 records wrapper nested-flag conflicts and direct-like writes without changing production source. [Existing review contract](modules/platform_integration/linkedin_agent/docs/LINKEDIN_REVIEW_WORKFLOW.md#rsi-dry-run-boundary-qualification--2026-09-22) defines the next14/P1 wrapper/direct-preview repair. Broader routes, live authority and RSI retention remain unqualified; current evidence and selection are in the canonical backlog.
