...
| Current RSI ticket path | PR1858 diagnostic-accounting repair is merged with PR/main checks passed and owned lane retired; temporary staging cleanup remains policy-blocked. Current broker import-streak repair12/P2 passes 13 fixed cases locally and independently, reaching the existing threshold while preserving recovery and admission boundaries. No live RSI or retained-learning proof. Exact publication and freshly scored next action are in the [backlog](docs/roadmaps/rsi_swarm_backlog.json); native18/P0 and FAM domain authority14/P1 remain blocked. |
