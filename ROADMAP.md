...
Preceding paginated REST inventory plus verified PR1836/1837/1838/1839/1840/1841/1842/1843/1378 closures accounts for150 merged/21 closed without merge;97 surviving peer heads remain unchanged after PR1378 closure. The preceding snapshot had13 drafts/14 with failing checks. PR1835 remains separately owned architecture documentation. Both PR1834 main workflows passed. These observations are not an atomic snapshot;
...
| Dependency work | Clerk1378 merged; both main workflows passed and GitHub alerts22/23fixed. Rootprotobuf783 current-base qualification/integration14/P1 changes6records and preserves344 including websocket-driver0.7.5. Strict isolated candidate/baseline installs pass. Original12case suiteFAILED on both at an unsupported truncated-Buffer rejection assumption;11trusted checks completed and6separate reader observations explain unchanged behavior. Narrow compatibility accepted independently; no strict-wire/security proof. Four-file candidate awaits final review/publication/exact-head checks. After owned closure, functions parent-package qualification15/P1 is next; other manifests/owners remain separate. |
