...
| Current RSI ticket path | PR1849 producer provenance is merged; CI/CodeQL and owned-lane cleanup passed. The15/P1 registered lifecycle consumer now captures the canonical boundary, consumes once and correlates exact requester/profile. Its local evidence and independent closure are in the backlog; related producer-test size debt is repaired by existing-suite consolidation. Next: qualify resident use-time correlation. All seven trust-anchor reasons and absent effect lease remain; R24 and reward correctness are incomplete. |
