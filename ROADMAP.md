...
| Current RSI ticket path | PR1893 ORM prerequisite is merged and retired with verified PR/main checks. [Atomic verification](docs/roadmaps/R24_AGENT_PRODUCTION_LINE_PACKET.md#atomic-verification-acceptance--2026-09-23) now passes 164 fixed local and independent cases after 23 baseline failures; publication/closure remains in the canonical backlog. Domain issuer/native admission still block AmIBot. Next research candidate qualifies whether actual AutoResearcher comparisons remain valid when evaluator dependencies change; no retained-RSI claim. |
