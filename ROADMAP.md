...
| Current RSI ticket path | PR1849 producer provenance is merged; CI/CodeQL and owned-lane cleanup passed. The15/P1 registered lifecycle consumer now captures the canonical boundary, consumes once and correlates exact requester/profile. Its local evidence and independent closure are in the backlog; related producer-test size debt is repaired by existing-suite consolidation. Resident correlation qualification found missing production OS-policy/dependency provenance and exact profile supply; no reason-removal patch is qualified. Next: existing payout transaction/idempotency qualification13/P1. All seven trust-anchor reasons and absent effect lease remain; R24 is incomplete. |
