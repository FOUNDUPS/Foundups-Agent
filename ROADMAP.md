...
- LinkedIn instruction owners PR1863/1865 and qualification PR1866 are closed. Existing wrapper/direct-like repair14/P1 passes54 fixed cases locally and independently (baseline29 failures/25 passes). [Current repair contract](modules/platform_integration/linkedin_agent/docs/LINKEDIN_REVIEW_WORKFLOW.md#rsi-dry-run-repair--2026-09-22) distinguishes early previews from live results. Re-scoring selects engagement-session dry-run13/P1 next; other routes, live authority and RSI retention remain unqualified. Exact publication and next-action evidence remain in the canonical backlog.
