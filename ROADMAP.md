...
| Current RSI ticket path | PR1897 profile qualification is merged, verified and retired. The [persistent comparison guard](modules/infrastructure/wre_core/ROADMAP.md#persistent-comparison-profile-guard--2026-09-24) passes 66 focused and 136 regression cases locally and independently, rejects persistent ambient-only gains and preserves genuine improvement. Next 14/P1 determines the intended WRE consumer boundary for ROC reports before extending oracle identity. Immutable consumption, native admission and retained RSI remain open. |
