...
| Current RSI ticket path | PR #1876 LinkedIn note repair is closed. Core canary qualification 15/P1 passes 15 frozen cases locally and independently: deferred callbacks remain uncalled at admission rejection; direct chain controls inspect schema/revision failures. The [backlog](docs/roadmaps/rsi_swarm_backlog.json) selects the next core prerequisite. AmIBot is registered but undispatched; Memory Horizon remains separate PR #1822. Native WRE/RSI and runtime-update readiness remain unproven. |
