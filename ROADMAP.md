...
| Current RSI ticket path | PR1857 scan-status repair is merged with PR/main checks passed and owned lane retired; temporary staging cleanup remains policy-blocked. Current diagnostic-accounting repair11/P2 passes 94 fixed cases locally and independently, separating structural checks from repair credit and escalation suppression. No live RSI or retained-learning proof. Exact publication and freshly scored next action are in the [backlog](docs/roadmaps/rsi_swarm_backlog.json); native18/P0 and FAM domain authority14/P1 remain blocked. |
